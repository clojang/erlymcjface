...
public abstract class GenEvent implements Process {

  protected abstract InitResult init(List<Term> args);

  protected abstract HandleEventResult handleEvent(Term event, Object state);

  protected abstract HandleCallResult handleCall(Term request, Object state);

  protected abstract HandleInfoResult handleInfo(Term info, Object state);
